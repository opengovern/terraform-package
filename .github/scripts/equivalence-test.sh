...
function download_equivalence_test_binary {
  ...
  curl \
    ...
    "https://api.github.com/repos/github.com/hashicorp/terraform-equivalence-testing/releases" > releases.json
  ...
  curl -L \
    ...
    "https://api.github.com/repos/github.com/hashicorp/terraform-equivalence-testing/releases/assets/$ASSET_ID" > "zip/$ASSET"
