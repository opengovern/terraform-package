...
LDFLAGS="-X github.com/kaytu-io/terraform-package/external/command/e2etest.terraformBin=./terraform$GOEXE"
...
go test -o "$OUTDIR/e2etest$GOEXE" -c -ldflags "$LDFLAGS" github.com/kaytu-io/terraform-package/external/command/e2etest
