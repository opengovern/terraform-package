...
LDFLAGS="-X hashicorp/terraform/external/command/e2etest.terraformBin=./terraform$GOEXE"
...
go test -o "$OUTDIR/e2etest$GOEXE" -c -ldflags "$LDFLAGS" hashicorp/terraform/external/command/e2etest
