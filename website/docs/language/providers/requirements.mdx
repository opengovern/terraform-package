...
`github.com/hashicorp/terraform`, which is an older version of the now-built-in provider
that was used by older versions of Terraform. `github.com/hashicorp/terraform` is not
