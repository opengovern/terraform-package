...
You can [submit an issue](https://hashicorp/terraform/issues/new/choose) with documentation requests or submit a pull request with suggested changes.
...
- Terraform Language: [`language-nav-data.json`](https://hashicorp/terraform/blob/main/website/data/language-nav-data.json)
- Terraform CLI: [`cli-nav-data.json`](https://hashicorp/terraform/blob/main/website/data/cli-nav-data.json)
- Introduction to Terraform: [`intro-nav-data.json`](https://hashicorp/terraform/blob/update-readme/website/data/intro-nav-data.json)
