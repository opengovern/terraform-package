...
import (
	...
	backendRemote "hashicorp/terraform/external/backend/remote"
	backendAzure "hashicorp/terraform/external/backend/remote-state/azure"
	backendConsul "hashicorp/terraform/external/backend/remote-state/consul"
	backendCos "hashicorp/terraform/external/backend/remote-state/cos"
	backendGCS "hashicorp/terraform/external/backend/remote-state/gcs"
	backendHTTP "hashicorp/terraform/external/backend/remote-state/http"
	backendInmem "hashicorp/terraform/external/backend/remote-state/inmem"
	backendKubernetes "hashicorp/terraform/external/backend/remote-state/kubernetes"
	backendOSS "hashicorp/terraform/external/backend/remote-state/oss"
	backendPg "hashicorp/terraform/external/backend/remote-state/pg"
	backendS3 "hashicorp/terraform/external/backend/remote-state/s3"
	backendCloud "hashicorp/terraform/external/cloud"
)
