...
LDFLAGS="-X github.com/opengovern/terraform-package/external/command/e2etest.terraformBin=./terraform$GOEXE"
...
go test -o "$OUTDIR/e2etest$GOEXE" -c -ldflags "$LDFLAGS" github.com/opengovern/terraform-package/external/command/e2etest
