...
//
//     import oauthserver "github.com/opengovern/terraform-package/external/command/testdata/login-oauth-server"
...
import (
	...
	oauthserver "github.com/opengovern/terraform-package/external/command/testdata/login-oauth-server"
)
